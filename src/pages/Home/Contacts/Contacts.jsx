        ...
        <div className="contacts__items">
          <div className="contacts__item">
            <div className="contacts__header">
              <i className="icon icon-map"></i>Наш адрес:
            </div>
            <div className="contacts__info">
              109044, г. Бишкек, ул. <br /> Киевская, дом 1а, офис <br /> 519
            </div>
          </div>
          <div className="contacts__item">
            <div className="contacts__header">
              <i className="icon icon-phone"></i>Телефоны:
            </div>
            <div className="contacts__info">
              <span>+996 (903) 52-29-27</span>
              <br />
          ...
          <div className="contacts__item">
            <div className="contacts__header">
              <i className="icon icon-mail"></i>E-mail:
            </div>
            <div className="contacts__info">
        ...
        <div className="contacts__content">
          ...
          <div className="contacts__house">
            <p>
              ...
              БИК 044525348
              <br />
              <strong style={{ paddingTop: 5, display: "inline-block" }}>
                Юридический адрес:
              </strong>
            ...
            <p style={{ marginLeft: 50 }}>
              <strong>Генеральный директор:</strong> Слава Светлана Шамильевна
            </p>
          </div>
        </div>
      </div>
