  ...
  return (
    <div className="services" id={3}>
      <div className="container">
        <h2 className="services__heading">УСЛУГИ</h2>
        <div className="services__wrapper">
          <div className="services__item">
            <div className="services__item-header">
              ...
              <div className="services__coast">
                <h3 className="services__price">1500</h3>
                <span>руб.</span>
              </div>
            </div>
          ...
          <div className="services__item services__item-top">
            <div className="services__item-header">
              ...
              От
              <div className="services__coast">
                <h3 className="services__price">31 500</h3>
                <span>руб.</span>
              </div>
            </div>
            <div className="services__item-list">
              <ul className="">
                ...
                <li>
                  Оформление таблиц, формул, сносок, списка литературы согласно
                  требованиям
                </li>
          ...
          <div className="services__item">
            <div className="services__item-header">
              ...
              От
              <div className="services__coast">
                <h3 className="services__price">14 000</h3>
                <span>руб.</span>
              </div>
            </div>
            <div className="services__item-list">
              <ul className="">
                ...
                <li>
                  Размещение издания в Научной электронной библиотеке (eLibrary)
                </li>
              </ul>
            </div>
            <button
        ...
        <p className="services__bottom">
          Цены, указанные на сайте, предназначены для ознакомления и не могут
