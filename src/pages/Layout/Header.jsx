                ...
                <div className="container-header">
                    <div className="header__nav">
                        ...
                        <ul className="header__menu">
                            <li className="header__menu-item" value={1} onClick={(e) => scrollToSection(e)}>
                                о компании
                            </li>
                            <li className="header__menu-item" value={2} onClick={(e) => scrollToSection(e)}>
                                новости
                            </li>
                            <li className="header__menu-item" value={3} onClick={(e) => scrollToSection(e)}>
                                услуги
                            </li>
                            <li className="header__menu-item" value={4} onClick={(e) => scrollToSection(e)}>
                                контакты
                            </li>
                        </ul>
                        <div>
